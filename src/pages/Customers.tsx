                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 pt-4 border-t">
                        ...
                        <div className={`p-3 rounded-lg ${
                          ...
                          <p className="text-sm text-muted-foreground mb-1">
                            {customer.current_credit < 0 ? "Crédito a Favor" : "Crédito Actual"}
                          </p>
                          <p className={`text-lg font-medium ${
                            customer.current_credit < 0 
                              ? "text-green-600" 
                        ...
                        <div className="bg-muted/30 p-3 rounded-lg">
                          ...
                          <p className="text-lg font-medium">
                            {formatCurrency(
                              customer.current_credit < 0 
                                ? customer.credit_limit + Math.abs(customer.current_credit)
                                : Math.max(0, customer.credit_limit - customer.current_credit), 
                              'USD'
                            )}
                          </p>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-3">
                    <div>
                      <p className="text-xs text-muted-foreground">
                        {selectedCustomer.current_credit < 0 ? "Crédito a Favor" : "Crédito Actual"}
                      </p>
                      <p className={`text-sm font-medium ${selectedCustomer.current_credit < 0 ? "text-green-600" : ""}`}>
